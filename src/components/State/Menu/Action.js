...
import { DELETE_EVENT_SUCCESS } from "../Restaurant/ActionTypes";
import { 
    ...
    UPDATE_MENU_ITEMS_SUCCESS} from "./ActionTypes";
...
// export const getAllIngredientsMenuItem = (reqData) => {
//     return async (dispatch) => {
//         dispatch({type: GETALLIN});
//         try {
...
export const updateMenuItemsAvailability = ({ foodId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type: UPDATE_MENU_ITEMS_SUCCESS, payload: data});
        } catch (error) {
            dispatch({type: UPDATE_MENU_ITEMS_FAILURE, payload: error});
        }
    };
};
...
export const deleteFoodAction = ({ foodId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type: DELETE_EVENT_SUCCESS, payload: foodId});
        } catch (error) {
            console.log("catch error ", error);
