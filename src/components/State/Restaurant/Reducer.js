...
const restaurantReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.GET_RESTAURANTS_CATEGORIES_REQUEST:
            return {
                ...state,
                loading: true,
                error: null,
        ...
        case actionTypes.GET_RESTAURANTS_CATEGORIES_SUCCESS:
            return {
                ...state,
                loading: false,
                restaurant: action.payload,
        ...
        case actionTypes.GET_RESTAURANTS_CATEGORIES_FAILURE:
            return {
                ...state,
                loading: false,
                restaurant: action.payload,
